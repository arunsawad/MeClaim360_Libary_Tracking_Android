...
import com.claimdi.databehaviortracking.DataBehabviorTracking
import com.claimdi.databehaviortracking.model.MqttConfig
import com.claimdi.databehaviortrakinglibrary.R
import com.claimdi.networklibrary.model.Status
...
class MainActivity : AppCompatActivity() {
    ...
    private fun configRetrofit() {
        ...
        val retrofit: Retrofit = retrofit2.Retrofit.Builder()
            ...
            .build()
        val service: DataApi = retrofit.create(
            DataApi::class.java)
        dataRepository =
